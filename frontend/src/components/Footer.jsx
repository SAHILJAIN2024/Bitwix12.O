      ...
      */}
      <div className="w-full max-w-[98%] mx-auto px-6 py-16 grid md:grid-cols-3 gap-10 items-center">
        ...
        <div className="flex flex-row items-center gap-6 justify-center">
          ...
          >
            <svg className="w-7 h-7 fill-gray-400 group-hover:fill-indigo-400 transition-colors" viewBox="0 0 24 24">
              <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z" />
            </svg>
            <span className="text-[10px] mt-1 font-bold text-gray-400 group-hover:text-indigo-400 uppercase tracking-tighter transition-colors text-center">Register</span>
          </a>
        </div>
